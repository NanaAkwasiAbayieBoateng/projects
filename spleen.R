...
spleen4$age_Dx[spleen4$age_Dx<60]
range[range==1]
...
if(data1$Agerange[i]==1&data1$Length[i] >95){
    enlarged[i] <- 1
} else if(data1$Agerange[i]==2&data1$Length[i] >105){
    enlarged[i] <- 1
}
 else if(data1$Agerange[i]==3&data1$Length[i] >105){
     enlarged[i] <- 1
}
 else if(data1$Agerange[i]==4&data1$Length[i] >110){
     enlarged[i] <- 1
}
 else if(data1$Agerange[i]==5&data1$Length[i] >115){
    enlarged[i] <- 1 
} 
 else if(data1$Agerange[i]==6&data1$Length[i] >120){
    enlarged[i] <- 1 
